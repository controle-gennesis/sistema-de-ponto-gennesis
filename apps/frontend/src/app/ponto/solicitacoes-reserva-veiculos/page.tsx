...
function suppliesStatCardClassName(): string {
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4">
            {SUPPLIES_STAT_CARDS.map((card) => {
              ...
              return (
                <Card key={card.filter} padding="none" className={suppliesStatCardClassName()}>
                  <CardContent
                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xl font-bold tabular-nums text-gray-900 dark:text-gray-100 sm:text-2xl">
                          {loadingStats ? '—' : suppliesStats[card.countKey]}
                        </p>
                      </div>
                    </div>
                  </CardContent>

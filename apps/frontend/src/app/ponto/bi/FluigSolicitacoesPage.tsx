              ...
              return (
                <div className="space-y-5">
                  ...
                  <Card className={`overflow-hidden border border-gray-200 dark:border-gray-700/80 ${useEmployeeListLayout ? 'shadow-sm' : ''}`}>
                    <div
                      className={`px-5 py-4 ${useEmployeeListLayout ? 'bg-white dark:bg-gray-900' : 'border-b border-gray-200 dark:border-gray-700/80 bg-gray-50/50 dark:bg-gray-800/30'}`}
                    >
                          ...
                          <div className="flex-none min-w-[260px]">
                            <div className="relative">
                              ...
                              <input
                                ...
                                className={`w-full min-w-0 pl-10 pr-10 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 ${useEmployeeListLayout ? 'rounded-md focus:ring-blue-500' : 'rounded-lg focus:ring-red-500'}`}
                              />
                              {searchText && (
                                <button
                                  type="button"
                      ...
                      return (
                        <>
                          ...
                          {compactView && totalPages > 1 && (
                            <div className={`flex items-center justify-between gap-4 px-5 py-3 border-t border-gray-200 dark:border-gray-700/80 ${useEmployeeListLayout ? 'bg-white dark:bg-gray-900' : 'bg-gray-50/50 dark:bg-gray-800/30'}`}>

...
export default function AlocacaoTestePage() {
  ...
  const { data: employeesResponse, isLoading: loadingEmployees } = useQuery({
    queryKey: ['employees-alocacao-teste', filters],
    queryFn: async () => {
  ...
  return (
    <ProtectedRoute route="/relatorios/alocacao-teste">
      <MainLayout 
        userRole={user.role} 
        userName={user.name} 
      ...
      <div className="space-y-6">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center space-x-3 mb-2">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Alocação de Funcionários (TESTE)</h1>
          </div>
          <p className="text-sm sm:text-base text-gray-600">Visualize a alocação de todos os funcionários - Página de Teste</p>
        </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4 min-w-0">
                  <h3 className="text-lg font-semibold text-gray-900">Alocação de Funcionários (TESTE)</h3>
                  <p className="text-sm text-gray-600">Dados de alocação dos funcionários - Página de Teste</p>
                </div>
              </div>
            </div>
          </CardHeader>

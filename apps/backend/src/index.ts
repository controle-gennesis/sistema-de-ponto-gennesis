...
import dpContabilidadeRoutes from './routes/dpContabilidade';
...
import empreiteiroRoutes from './routes/empreiteiros';
...
import scheduledNewsRoutes from './routes/scheduledNews';
...
import caixinhaRoutes from './routes/caixinha';
...
app.use('/api/dp-contabilidade', dpContabilidadeRoutes);
...
app.use('/api/news', scheduledNewsRoutes);
